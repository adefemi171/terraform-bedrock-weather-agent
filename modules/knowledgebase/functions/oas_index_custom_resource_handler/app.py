    ...
    try:
        if action == "Create" or action == "Update":
            ...
            if index_exists:
                ...
                response = {"acknowledged": True, "message": "Index already exists"}
            else:
            ...
            if not index_exists:
                ...
                response = {"acknowledged": True, "message": "Index does not exist"}
            else:
        ...
        return {
            'statusCode': 500,
            'body': json.dumps({'message': 'Index create command failed', 'error': str(err)})
        }
